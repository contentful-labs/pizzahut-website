  ...
  return (
    <nav className="sticky top-0 z-50">
      ...
      <div className="bg-white border-b border-gray-200">
        <div className="max-w-7xl mx-auto px-4 flex items-center justify-center gap-6 py-3">
          <span className="text-sm text-gray-600">Select your store for local menus &amp; pricing</span>
          <div className="flex items-center gap-3">
            <button className="flex items-center gap-2 px-6 py-2.5 border border-ph-red rounded-md text-ph-dark font-bold text-sm uppercase hover:bg-red-50 transition-colors">
            ...
            <button className="flex items-center gap-2 px-6 py-2.5 border border-ph-red rounded-md text-ph-dark font-bold text-sm uppercase hover:bg-red-50 transition-colors">
              <svg className="w-5 h-5" fill="none" viewBox="0 0 24 24" stroke="currentColor" strokeWidth={2}>
                <path strokeLinecap="round" strokeLinejoin="round" d="M8.25 18.75a1.5 1.5 0 0 1-3 0m3 0a1.5 1.5 0 0 0-3 0m3 0h6m-9 0H3.375a1.125 1.125 0 0 1-1.125-1.125V14.25m17.25 4.5a1.5 1.5 0 0 1-3 0m3 0a1.5 1.5 0 0 0-3 0m3 0H21M3.375 14.25h3.068c.307 0 .595-.163.75-.44l1.932-3.453A.75.75 0 0 1 9.787 10H17.5a.75.75 0 0 1 .707.5l1.043 3.125a.75.75 0 0 0 .707.5h.668a1.125 1.125 0 0 1 1.125 1.125v2.5" />
              </svg>
              Delivery
            </button>
          </div>
